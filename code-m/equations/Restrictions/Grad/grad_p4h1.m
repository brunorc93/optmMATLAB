function [ g_penalidade_valor ] = grad_p4h1( x )
...
% exemplo 4
        ...
        g_penalidade_valor(1) = 2*(x(1)+2*x(2)+x(3)-1);
        g_penalidade_valor(2) = 4*(x(1)+2*x(2)+x(3)-1);
        g_penalidade_valor(3) = 2*(x(1)+2*x(2)+x(3)-1);
        g_penalidade_valor(4) = 0;
        g_penalidade_valor(4) = 0;
