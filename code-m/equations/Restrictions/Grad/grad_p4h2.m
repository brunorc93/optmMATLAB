function [ g_penalidade_valor ] = grad_p4h2( x )
...
% exemplo 4
        ...
        g_penalidade_valor(1) = 0;
        g_penalidade_valor(2) = 0;
        g_penalidade_valor(3) = 2*(x(3)-2*x(4)+x(5)-6);
        g_penalidade_valor(4) = -2*2*(x(3)-2*x(4)+x(5)-6);
        g_penalidade_valor(5) = 2*(x(3)-2*x(4)+x(5)-6);
