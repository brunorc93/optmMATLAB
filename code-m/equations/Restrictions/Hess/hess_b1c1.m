function [ h_penalidade_valor ] = hess_b1c1( x )
...
%         f_penalidade_valor = 1/2*((max(0,-2-x(1)-2*x(2)))^2+(max(0,8-6*x(1)+(x(1))^2-x(2)))^2);
          h_penalidade_valor(1,1) = 2*(1/(-2 -x(1) -2*x(2))^3);
          h_penalidade_valor(1,2) = 4*(1/(-2 -x(1) -2*x(2))^3);
          h_penalidade_valor(2,1) = 4*(1/(-2 -x(1) -2*x(2))^3);
          h_penalidade_valor(2,2) = 8*(1/(-2 -x(1) -2*x(2))^3);
% % exemplo 2
%         %st.: 2x1 +x2 -2 <=0
%         %     -x2 +1 <=0
