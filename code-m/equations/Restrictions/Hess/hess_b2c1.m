function [ h_penalidade_valor ] = hess_b2c1( x )
...
% exemplo 2
        ...
        h_penalidade_valor(1,1) = 8*(1/(2*x(1) + x(2) - 2)^3);
        h_penalidade_valor(1,2) = 4*(1/(2*x(1) + x(2) - 2)^3);
        h_penalidade_valor(2,1) = 4*(1/(2*x(1) + x(2) - 2)^3);
        h_penalidade_valor(2,2) = 2*(1/(2*x(1) + x(2) - 2)^3);
% % exemplo 3
%         %st.: x1^2 - x2 <=0
